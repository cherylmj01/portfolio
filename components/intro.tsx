...
import myPic from "@/public/my_pic.png";
...
export default function Intro() {
  ...
  return (
    ...
    min-h-screen mb-28 max-w-[50rem] 
    mx-auto text-center sm:mb-0 scroll-mt-[100rem]"
    >
        <div 
        ...
        >
            <div className="relative">
                ...
                >
                    ...
                    object-cover object-center border-[0.35rem] border-white shadow-xl"
                    />
                </motion.div>
                <motion.span 
      ...
      >
        <span className="font-bold">Hello, I'm Cheryl.</span> I'm a{" "}
      ...
      >
        ...
        active:scale-105 transition cursor-pointer border-black/10 dark:bg-white/10"
        href="/CV.pdf" 
        download
        >
        ...
        href="https://www.linkedin.com/in/cherylmyers1/"
        target="_blank"
        >
            <BsLinkedin />
        </a>
        <a
          ...
          href="https://github.com/cherylmj01"
          target="_blank"
        >
          <FaGithubSquare />
        </a>
