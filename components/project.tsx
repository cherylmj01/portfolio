        ...
        <div className="pt-4 pb-7 px-5 sm:pl-10 sm:pr-2 sm:pt-10 sm:max-w-[50%] flex flex-col h-full sm:group-even:ml-[18rem]">
          ...
          <div className="flex flex-wrap mt-4 gap-2 sm:mt-auto">
            <a
              ...
              target="_blank"
              className="mr-4 mt-4 bg-indigo-500/75 text-white px-3 py-1 leading-10 shadow-lg text-[0.7rem] uppercase transition-all ease-in-out duration-150 no-underline hover:bg-indigo-200 rounded"
            >
              Live Demo
